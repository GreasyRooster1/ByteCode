...
function JsGraphic(props) {
    ...
    let yellowAnim = {
        initial:{pathLength:.2,pathOffset:0,pathSpacing:1},
        animate:{pathLength:.2,pathOffset:1,pathSpacing:1},
        transition:{
            repeatType:"loop",
            repeat:Infinity,
            duration:1,
    ...
    return (
        <motion.svg className={props.className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 244 102" fill="none">
            ...
            <motion.path {...yellowAnim} d="M11 0.5H79.5C81.7091 0.5 83.5 2.29086 83.5 4.5V13C83.5 15.2091 85.2909 17 87.5 17H103.5" stroke="#F1C31C"/>
            <motion.path {...yellowAnim} d="M0 28.5H68.5C70.7091 28.5 72.5 30.2909 72.5 32.5V41C72.5 43.2091 74.2909 45 76.5 45H92.5" stroke="#F1C31C"/>
            <motion.path {...yellowAnim} d="M10 101.5H78.5C80.7091 101.5 82.5 99.7091 82.5 97.5V89C82.5 86.7909 84.2909 85 86.5 85H102.5" stroke="#F1C31C"/>
            <motion.path {...yellowAnim} d="M0 80H68.5C70.7091 80 72.5 78.2091 72.5 76V67.5C72.5 65.2909 74.2909 63.5 76.5 63.5H92.5" stroke="#F1C31C"/>
            <motion.path {...yellowAnim} d="M232.5 0.5H164C161.791 0.5 160 2.29086 160 4.5V13C160 15.2091 158.209 17 156 17H140" stroke="#F1C31C"/>
            <motion.path {...yellowAnim} d="M243.5 28.5H175C172.791 28.5 171 30.2909 171 32.5V41C171 43.2091 169.209 45 167 45H151" stroke="#F1C31C"/>
            <motion.path {...yellowAnim} d="M233.5 101.5H165C162.791 101.5 161 99.7091 161 97.5V89C161 86.7909 159.209 85 157 85H141" stroke="#F1C31C"/>
            <motion.path {...yellowAnim} d="M243.5 80H175C172.791 80 171 78.2091 171 76V67.5C171 65.2909 169.209 63.5 167 63.5H151" stroke="#F1C31C"/>
